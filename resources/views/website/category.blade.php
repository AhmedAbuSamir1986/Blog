    ...
    <div class="container-fluid">
        <div class="container">
            <nav class="breadcrumb bg-transparent m-0 p-0">
                ...
                <span class="breadcrumb-item">{{ __('words.categories') }}</span>
                <span class="breadcrumb-item active">{{ $category->translate(app()->getLocale())->title }}</span>
            </nav>
        </div>
    </div>
    <!-- Breadcrumb End -->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-flex align-items-center justify-content-between bg-light py-2 px-4 mb-3">
                                <h3 class="m-0">{{ $category->translate(app()->getLocale())->title }}</h3>

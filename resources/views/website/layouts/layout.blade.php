...
<body>
    ...
    <div class="container-fluid bg-light pt-5 px-sm-3 px-md-5">
        <div class="row">
            ...
            <div class="col-lg-2 col-md-2 mb-5">
                <h4 class="font-weight-bold mb-4">{{ __('words.languages') }}</h4>
    ...
    <div class="container-fluid py-4 px-sm-3 px-md-5">
        <p class="m-0 text-center">
            &copy; <a class="font-weight-bold" href="#">{{ $setting->translate(app()->getLocale())->title }}</a>. {{ __('words.all rights reserved') }}.

            
            {{ __('words.designed by') }} <a class="font-weight-bold" href="https://wow-des.com">{{ __('words.wow design') }}</a>
        </p>
    </div>
    <!-- Footer End -->

    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-menu">
            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                ...
                <a href="{{ route('dashboard.index') }}" class="btn btn-secondary"><i class="icon-speedometer"></i> {{ __('words.dashboard') }}</a>
                <a href="{{ route('dashboard.category.index') }}" class="btn btn-secondary"><i class="fa fa-tags"></i> {{ __('words.categories') }}</a>
            </div>
        </li>
    </ol>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <i class="fa fa-align-justify"></i> {{ __('words.categories table') }}
                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <p>{{ __('words.sure delete category') }}</p>
                            @csrf

    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-menu">
            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                ...
                <a href="{{ route('dashboard.posts.index') }}" class="btn btn-secondary"><i class="fa fa-tags"></i> {{ __('words.posts') }}</a>
            </div>
        </li>
    </ol>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <i class="fa fa-align-justify"></i> {{ __('words.posts table') }}
                </div>

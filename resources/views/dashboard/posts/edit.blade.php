...
@section('body')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('dashboard.posts.index') }}">{{ __('words.posts') }}</a>
        </li>
        ...
        <li class="breadcrumb-menu">
            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                ...
                <a class="btn btn-secondary" href="{{ route('dashboard.posts.index') }}"><i class="fa fa-newspaper"></i> &nbsp;{{ __('words.posts') }}</a>
                <a class="btn btn-secondary"><i class="icon-notebook"></i> &nbsp;{{ __('words.edit post') }}</a>
            </div>
        </li>
    </ol>
                ...
                <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <div class="form-group col-md-12">
                                <label>{{ __('words.post image') }}</label>
                                <input type="file" name="image" class="form-control"
                                    placeholder="{{ __('words.post image') }}">
                            </div>

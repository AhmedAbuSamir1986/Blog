...
@section('body')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('dashboard.users.index') }}">{{ __('words.users') }}</a>
        </li>
        <li class="breadcrumb-item active">{{ __('words.edit user') }}</li>

        <!-- Breadcrumb Menu-->
        <li class="breadcrumb-menu">
            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                <a class="btn btn-secondary" href="#"><i class="icon-speech"></i></a>
                <a class="btn btn-secondary" href="{{ route('dashboard.users.index') }}"><i class="icon-speedometer"></i> &nbsp;{{ __('words.users') }}</a>
                <a class="btn btn-secondary" href="#"><i class="icon-user-follow"></i> &nbsp;{{ $user->name }}</a>
            </div>
        </li>
    </ol>

    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-menu">
            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                ...
                <a class="btn btn-secondary" href="{{ route('dashboard.users.index') }}"><i class="icon-people"></i> &nbsp;{{ __('words.users') }}</a>
                <a class="btn btn-secondary"><i class="icon-user-follow"></i> &nbsp;{{ __('words.add user') }}</a>
            </div>
        </li>
    </ol>

        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-menu">
                <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                    ...
                    <a class="btn btn-secondary" href="./"><i class="icon-speedometer"></i> &nbsp;{{ __('words.dashboard') }}</a>
                    <a class="btn btn-secondary" href="{{ route('dashboard.settings') }}"><i class="icon-settings"></i> &nbsp;{{ __('words.setting') }}</a>
                </div>
            </li>
        </ol>
